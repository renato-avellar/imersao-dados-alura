...
tamanhos_selecionados = st.sidebar.multiselect('Tamanhos de empresas', tamanhos_disponiveis, default=tamanhos_disponiveis)

#Filtragem dos Dataframes
#O df principal é filtrado com base nas seleções feitas na barra lateral
...
st.markdown("Explore os dados salariais na área de dados nos últimos anos. Utilize os filtros a esquerda para selecionar as opções que você deseja.")

# Metricas principais (KPIS)
st.subheader('Metricas gerais (Salário Anual em USD')

if not df_filtrado.empty:
    salario_medio = df_filtrado['usd'].median()
